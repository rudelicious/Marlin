...
#define STRING_CONFIG_H_AUTHOR "rudelicious" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 0  //@_ Enable UART port on Re-Arm 
...
#define DELTA
  ...
  #define DELTA_HEIGHT 255.90//_20200328 250.00             // (mm) Get this value from G33 auto calibrate
