...
#define STRING_CONFIG_H_AUTHOR "Wasn't me..." // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 255.43//255.90//_20200328 250.00             // (mm) Get this value from G33 auto calibrate
