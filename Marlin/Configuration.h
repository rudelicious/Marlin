...
#define Z_MIN_ENDSTOP_INVERTING true //_DELTA // Set to true to invert the logic of the endstop.
...
#define NEOPIXEL_LED 
  ...
  #define NEOPIXEL_PIN    P1_21//SERVO1_PIN //P1_31//P1_22 //P2_06      // LED driving pin
